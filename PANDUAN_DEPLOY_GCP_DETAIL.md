...
```
*Anda tidak perlu menjalankan perintah di atas secara manual jika Anda menggunakan script otomatis.*
...
gcloud sql import sql presensi-db-gcp gs://presensi-db-import-876/absensi_smk_alhafidz.sql \
    ...
    --quiet
```
*Tunggu hingga proses selesai. Jika berhasil, akan muncul konfirmasi status keberhasilan.*
...
```
*Pastikan halaman tersebut menampilkan teks baris data metrik sistem (Prometheus format) dan tidak menghasilkan error.*
